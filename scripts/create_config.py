...
max_number_of_markets = 101     # Add the top N markets to our config file.
...
config_file.write('ticker_converter = dict(\n')
...
print("Finished writinh the config file.")
